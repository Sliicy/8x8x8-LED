...
9) Beneath the 8x8x8 board (on the smaller yellow board), ensure that both switches are set to 0 (Run/Boot0 = 0 and Download/Boot1 = 0)
...
13) Toggle both switches on the yellow board so that they are both set to 1 (Run/Boot0 = 1 and Download/Boot1 = 1)
